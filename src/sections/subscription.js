...
export function renderSubscription() {
  return `
    <section class="section" id="precios" style="padding: 4rem 1.5rem 6rem; background-color: var(--bg-body); min-height: calc(100vh - 72px); display: flex; flex-direction: column; justify-content: center;">
      <style>
        .pricing-grid {
          display: grid;
      ...
      <div class="container" style="max-width: 1300px; width: 100%; margin: 0 auto;">
        ...
        <div class="pricing-grid">
          ...
          <!-- Plan Free (Broma) -->
          <div class="pricing-card" style="background:white;border-radius:16px;border:1px dashed #cbd5e1;padding:1.5rem;display:flex;flex-direction:column;opacity:0.7;position:relative;">
            <h3 style="font-size:1.3rem;font-weight:800;color:#64748b;margin-bottom:0.25rem;">Plan Free</h3>
            <p style="font-size:0.9rem;color:var(--text-muted);margin-bottom:1rem;">Para los que aman vivir al límite y perder ventas.</p>
            ...
            <button style="width:100%;border:1px solid #cbd5e1;background:#f1f5f9;color:#94a3b8;font-weight:600;padding:0.8rem;border-radius:8px;cursor:not-allowed;font-family:inherit;">Plan actual</button>
          </div>
          ...
          <div class="pricing-card" style="background:white;border-radius:16px;border:2px solid var(--brand);padding:1.5rem;display:flex;flex-direction:column;position:relative;">
            ...
            <p style="font-size:0.9rem;color:var(--text-muted);margin-bottom:1rem;">Flexibilidad total, cancela cuando quieras.</p>
            <div style="margin-bottom:1.25rem;">
            ...
            <a href="/pago?plan=mensual" data-link data-track="pricing_monthly_click" class="btn-subscribe" style="text-decoration:none;">
              Suscribirme
          ...
          <div class="pricing-card" style="background:white;border-radius:16px;border:2px solid var(--brand);padding:1.5rem;display:flex;flex-direction:column;position:relative;box-shadow:0 15px 30px -10px rgba(37,99,235,0.15);">
            ...
            <a href="/pago?plan=anual" data-link data-track="pricing_annual_click" class="btn-subscribe annual" style="text-decoration:none;">
              Suscribirme
              <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
          </div>
          ...
          <div class="pricing-card" style="background:white;border-radius:16px;border:2px solid var(--brand);padding:1.5rem;display:flex;flex-direction:column;position:relative;">
            ...
            <a href="#" class="btn-subscribe open-contact-modal" data-track="pricing_custom_click" style="text-decoration:none;">
              Contáctanos
              <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
            </a>
          </div>
