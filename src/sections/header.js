...
export function renderHeader() {
  return `
    <header class="navbar">
      <div class="navbar-container premium-reflejo">
        ...
        <a href="/" data-link data-track="nav_logo_click" class="logo" aria-label="SOLOMYCRM - Inicio">
          ...
          <strong class="logo-text">SOLOMYCRM.COM</strong>
        </a>
        ...
        <nav class="nav-menu">
          ...
          <a href="/funcionalidades" data-link data-track="nav_funcionalidades_click" class="nav-link">Módulos</a>
          
          <a href="/contacto" data-link data-track="nav_demo_click" class="nav-link btn btn-primary">Comenzar</a>
        </nav>
      </div>
    </header>
  `;
