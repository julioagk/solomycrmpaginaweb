  ...
  if (sessionId) {
    rightCardContent = `
      <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; text-align: center;">
        ...
        <p style="font-size: 1.05rem; color: #64748b; margin-bottom: 2rem; line-height: 1.6;">Tu cuenta ha sido creada correctamente. Las credenciales de acceso se han enviado a tu correo.</p>
